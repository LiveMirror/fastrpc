...
#ifndef IPCS_COMMON_NET_URI_URI_H
#define IPCS_COMMON_NET_URI_URI_H
...
inline void swap(net::UriAuthority& x, net::UriAuthority& y)
{
    x.Swap(&y);
}

inline void swap(net::URI& x, net::URI& y)
{
    x.Swap(&y);
}
...
#endif // IPCS_COMMON_NET_URI_URI_H
