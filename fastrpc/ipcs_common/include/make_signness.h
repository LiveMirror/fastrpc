...
// Created: 05/08/13
// Description: make signess
// GLOBAL_NOLINT(whitespace/newline)
// GLOBAL_NOLINT(readability/braces)
// GLOBAL_NOLINT(runtime/int)

#ifndef IPCS_COMMON_BASE_TYPE_TRAITS_MAKE_SIGNNESS_H
#define IPCS_COMMON_BASE_TYPE_TRAITS_MAKE_SIGNNESS_H
#pragma once
...
#endif // IPCS_COMMON_BASE_TYPE_TRAITS_MAKE_SIGNNESS_H
